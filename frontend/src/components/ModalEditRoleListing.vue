        ...
        <div
            ...
            <div class="modal-content">
                <div class="modal-header border-0 p-4">
                    <div class="modal-title text-h2" id="editModalLabel">
                        Edit Role Listing
                    </div>
                    <button
                        type="button"
                ...
                <div class="modal-body p-4">
                    ...
                    <form class="flex flex-wrap md:justify-between">
                        <div class="w-full md:w-auto flex-col mb-6">
                            <label for="roleName" class="form-label text-h3"
                                >Role Name</label
                            >
                            <input
                                id="roleName"
                        ...
                        <div class="w-full md:w-auto flex-col mb-6">
                            <label for="roleDeadline" class="form-label text-h3"
                                >Deadline</label
                            >
                            <div class="text-bold">
                                <VueDatePicker
                    ...
                    <div class="">
                        <label for="roleDescription" class="form-label text-h3">
                            Role Description
                        </label>
                        <textarea
                            id="roleDescription"
